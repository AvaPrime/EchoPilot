...
We strive to use inclusive language in all our communications. This includes:

- Using gender-neutral language when possible
- Avoiding assumptions about technical background or experience level
- Being mindful of cultural differences and perspectives
- Using clear, accessible language in documentation and discussions

### Technical Discussions

When engaging in technical discussions:

- **Be constructive**: Focus on the code, design, or idea, not the person
- **Provide context**: Explain your reasoning and provide examples when possible
- **Be open to feedback**: Consider alternative approaches and be willing to change your mind
...
- **Share knowledge** through documentation, examples, and discussions
- **Celebrate successes** and acknowledge contributions of all sizes

### Conflict Resolution

If you experience or witness a conflict:

1. **Address it directly** if you feel comfortable and safe doing so
2. **Seek mediation** from community leaders if direct resolution isn't possible
3. **Report serious violations** to the enforcement team
